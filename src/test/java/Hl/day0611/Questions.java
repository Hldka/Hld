...
public class Questions {
    /*
    1)valueOf(String s) ile parseByte(String s) methodları arasındaki farklar nelerdir?
...
3)Ali'nin doğum tarihi 4 Haziran 1997'dir. Ali'nin doğum tarihinden
 2 yıl, 3 ay ve 12 gün sonraki tam tarihi bulmak için kodu yazınız.
...
125 yukarı yuvarlanacak ve değer 130 olacaktır. 123 aşağı yuvarlanacak ve değer 120 olacaktır.
  7)Verilen ay numaralarından başlayarak tüm ay adlarını yazdıran bir kod yazınız.
...
10)Aşağıdaki 20×20 ızgarada, çapraz bir çizgi boyunca dört sayı kırmızı ile işaretlenmiştir.
